...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!file_exists('d3jsWarst10.json')) {
        $existingData = [];
    } else {
        $existingData = json_decode(file_get_contents('d3jsWarst10.json'), true);
    }
    ...
    file_put_contents('d3jsWarst10.json', json_encode($existingData));
