...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!file_exists('canvasjsPoprawnie10000.json')) {
        $existingData = [];
    } else {
        $existingData = json_decode(file_get_contents('canvasjsPoprawnie10000.json'), true);
    }
    ...
    file_put_contents('canvasjsPoprawnie10000.json', json_encode($existingData));
