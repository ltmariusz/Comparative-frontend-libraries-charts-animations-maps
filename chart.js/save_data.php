...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!file_exists('chartjs100000.json')) {
        $existingData = [];
    } else {
        $existingData = json_decode(file_get_contents('chartjs100000.json'), true);
    }
    ...
    file_put_contents('chartjs100000.json', json_encode($existingData));
